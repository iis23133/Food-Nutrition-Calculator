...
function loadData() {
    ...
    if (savedFoods) {
        for (const [foodName, foodData] of Object.entries(savedFoods)) {
            ...
            foodItem.querySelector('.carbs-value').textContent = foodData.carbs.toFixed(0);
            foodItem.querySelector('.protein-value').textContent = foodData.protein.toFixed(0);
            foodItem.querySelector('.fat-value').textContent = foodData.fat.toFixed(0);
            foodItem.querySelector('.calories-value').textContent = foodData.calories.toFixed(0);
