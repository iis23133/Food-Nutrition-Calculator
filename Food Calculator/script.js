...
function updateNutritionTarget() {
    ...
    remainingCarbs.textContent = document.getElementById('target-carbs').textContent - totalCarbs;
    remainingProtein.textContent = document.getElementById('target-protein').textContent - totalProtein;
    remainingFat.textContent = document.getElementById('target-fat').textContent - totalFat;
    remainingCalories.textContent = document.getElementById('target-calories').textContent - totalCalories;
